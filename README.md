...
- View, search, and sort shortened URLs by clicks, unique visitors, creation date, expiration days, or last visit time, with click counts, unique visitors, last visit time, creation timestamps, expiration periods, and status in an admin page with improved responsive layout.
